...
--insert default rows
insert into projects(id, status, name, category, tags, notes) values (1, 'WIP', 'Default', 'Study', 'default,auto,programming', 'Default project auto generated by SimplePMS');